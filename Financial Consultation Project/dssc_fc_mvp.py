...
def main():
    ...
    company_list = {'Alphabet': 'GOOG', 'Apple': 'AAPL', 'BMO': 'BMO.TO', 'Cisco': 'CSCO', 'IBM': 'IBM', 'Meta': 'META',
                    'Microsoft': 'MSFT', 'Nvidia': 'NVDA', 'Oracle': 'ORCL', 'RBC': 'RY.TO', 'Scotia': 'BNS.TO', 'TSM': 'TSM',
                    'TXN': 'TXN', 'VZ': 'VZ'}
    ...
    for company_name, company_stock_name in company_list.items():
        ...
        company_name = storage_information.S3DatabaseActions.update_files_to_latest_data(company_name, company_stock_name)
